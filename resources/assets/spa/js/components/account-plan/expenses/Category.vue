            ...
            <div class="container">
                <div class="row">
                    <div class="col offset-s4 s4">
                        <ul class="tabs">
                            <li class="tab col s6">
                                <a v-link="{name: 'account-plan-revenues'}" >Revenues</a>
                            </li>
                            <li class="tab col s6">
                                <a v-link="{name: 'account-plan-expenses'}" class="active" >Expenses</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<script type="text/javascript">
    import {AccountPlanExpenses} from '../../../services/resources';
    import CategoryListComponent from './CategoryList.vue';
    import CategoryCreateComponent from './CategoryCreate.vue';
    import {CategoryFormat, CategoryService} from '../../../services/account-plan-expenses-nsm';
    ...
    export default {
        ...
        methods: {
            getCategories() {
                AccountPlanExpenses.query().then(response => {
