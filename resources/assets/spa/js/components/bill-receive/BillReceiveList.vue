<template>
    ...
    <table class="bordered striped highlight responsive-table">
        ...
        <tr v-for="(index, bill) in bills">
            ...
            <td>
                <a v-link="{ name: 'bills-receive.update', params: {id: bill.id} }">
                    <i class="material-icons">mode_edit</i>
                </a>
                <a v-link="{name: 'bills-receive.delete', params: {id: bill.id}}" @click.prevent="openModalDelete(bill)">
    ...
    <div class="fixed-action-btn">
        <a class="btn-floating btn-large" v-link="{name: 'bills-receive.create'}">
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            destroy() {
                BillsReceived.delete({id: this.billToRemove.id}).then((response) => {
