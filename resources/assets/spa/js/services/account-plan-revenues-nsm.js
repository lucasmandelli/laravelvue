import {AccountPlanRevenues} from './resources';
...
export class CategoryService {
    ...
    static new(category, parent, categories) {
        ...
        return AccountPlanRevenues.save(categoryCopy).then(response => {
    ...
    static edit(category, parent, categories, categoryOriginal) {
        ...
        return AccountPlanRevenues.update({id: categoryCopy.id}, categoryCopy).then(response => {
    ...
    static destroy(category, parent, categories) {
        ...
        return AccountPlanRevenues.delete({id: category.id}).then(response => {
